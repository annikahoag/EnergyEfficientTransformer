# -*- coding: utf-8 -*-
"""Preprocess_TransNAS_TSAD.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1z9EJc02w7SRsHmy_7Nex54zuwuRv3Gd_
"""

import os

DATA_PATH = r'C:\Users\ahoag\Desktop\EnergyEfficientTransformer\TransNAS_TSAD-main'  # Replace with your actual path
...
class Config:
    def __init__(self):
		# TODO: SMD wasn't on the GitHub so rn it is not something we can work with 
		# TODO: WADI requires files that aren't on the GitHub b/c they don't have the rights
        self.dataset = 'MBA'  # Replace with your dataset name.
...
def load_data(dataset):
	...
	if dataset == 'SMD':
		#TODO: this folder doesn't actually exist we'd have to get that from somewhere 
		dataset_folder = r'data\SMD'
		...
		dataset_folder = r'data\SMAP_MSL'
